...
<nav class="navbar navbar-expand-lg bg-body-tertiary" style="background-color: #f88b0d !important;" >
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ route('categorias.create') }}">Administrar Categorias</a></li>
